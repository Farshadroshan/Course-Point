...
class _UserhomeScreenState extends State<UserhomeScreen> {
  ...
  //   if (kIsWeb) {
  //     // On web, assume the imagePath is a URL
  //     return Image.network(
  //       imagePath,
  //       height: 130,
  //       width: double.infinity,
  //       fit: BoxFit.cover,
  //       errorBuilder: (context, error, stackTrace) => Image.asset("assets/Avatar.png", height: 130, width: double.infinity, fit: BoxFit.cover),
  //     );
  //   } else {
  //     // On mobile, check if image is from assets or a file path
  //     return imagePath.contains("assets/")
  //         ? Image.asset(imagePath, height: 130, width: double.infinity, fit: BoxFit.cover)
  //         : Image.file(File(imagePath), height: 130, width: double.infinity, fit: BoxFit.cover);
  //   }
