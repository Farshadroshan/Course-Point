...
//                   // buildTextField(courseDescription, "Enter course description", 1),
//                   // buildDescriptionTextField(courseDescription, 'Enter the Description', _scrollController,),
...
//         });
//       setState(() => video = pickedFile.path);
//     }
//   }
...
//             videoController!.play();
//           });
//         setState(() => videoPath = pickedFile.path);
//       }
//     }
//   }
...
//     final course = CoursesModel(
//       image: kIsWeb ? imageBase64! : imagePath!,
//       coursetitle: addCourseTitle.text,
//       Description: courseDescription.text,
//       indroductionvideo: kIsWeb ? videoFile!.path : videoPath!,
//     );
